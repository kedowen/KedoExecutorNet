...
namespace Kedo.Comm.EmailMessage
{
    public class EmailMessageHelper
    {
        ...
        public EmailMessageHelper(ILogger<EmailMessageHelper> logger)
        {
            _logger = logger;
        ...
        /// <returns></returns>
        public MessageSendModel SendEmailCode(string mToEmail, string subject, string messageBody)
        {
            ...
            try
            {
                ...
                message.To.Add(new MailboxAddress(mEmailName, mToEmail));
