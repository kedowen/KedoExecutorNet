...
namespace Kedo.Comm.LLm.Claude
{
    public class ClaudeHelper
    {
        ...
        /// <returns></returns>
        public static async Task<string> ProcessClaudeAsync(AgentFlowLLMInput agentFlowLLMInput)
        {
            string onUseUrl = "https://api.onechats.cn/v1/chat/completions";
            string onUseKey = "**";
